...
def create_interview_flowchart():
    ...
    section_graph.add_node("ask_custom_question", function=ask_custom_question)
    section_graph.add_node("get_applicant_response-7", 
                        function=get_response_from_applicant_persona
                        )
    section_graph.add_node("validate_answer_to_custom_question", function=validate_answer_to_custom_question)
    ...
    section_graph.add_edge("ask_custom_question", "get_applicant_response-7")
    section_graph.add_edge("get_applicant_response-7", "validate_answer_to_custom_question")
    section_graph.add_edge("validate_answer_to_custom_question", "empty_node", passthrough_values=[0,1,2,3])
